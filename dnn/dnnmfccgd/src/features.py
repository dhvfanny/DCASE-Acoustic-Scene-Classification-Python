...
def feature_extraction_lp_group_delay(y, fs=44100, statistics=True, include_delta=True,
    ...
    y = y + eps  
    frames = segment_axis(y, win_params['win_length'], win_params['hop_length']+1);
    #  frames = librosa.util.frame(y, frame_length=win_params['win_length'], hop_length=win_params['hop_length'])
    ...
    if include_delta:
        ...
        feature_matrix = numpy.hstack((feature_matrix, feature_delta))
    ...
    if include_acceleration:
        ...
        feature_matrix = numpy.hstack((feature_matrix, feature_delta2))
